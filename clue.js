...
let weaponsArray = [
  pistol,trophy,bat,axe,poison,axe,dumbbell,candlestick,knife,rope
]
...
// ### loops through all of our arrays and shows eachItems name
...
function guess () {
  ...
  if(
    ...
    && guessedWeapon === mystery.weapons.name)
    {
      ...
      alert ("You guessed wrong! You lost")
